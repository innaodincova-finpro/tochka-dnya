...
(async()=>{
 ...
 async function check(name,{auth='Bearer test',method='GET',owner=true,confirmed=true,secret=token,username='Inna_Assistant_bot',throwNetwork=false,telegramStatus=200}={},expected){
