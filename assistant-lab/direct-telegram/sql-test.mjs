...
const user='00000000-0000-4000-8000-000000000001',hook='a'.repeat(64),now=Date.now(),payload={ev:[{id:'old',title:'existing'}],exp:[],inc:[],notes:[],settings:{theme:'dark',reminderMode:'three-and-hour'},del:[],day:{},savedAt:'old'};
