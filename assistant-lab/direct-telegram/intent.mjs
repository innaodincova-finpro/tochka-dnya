...
const AMBIGUITY_TEXT={
 ...
 reminder_details:'Я понял, что это напоминание, но в нём указаны разные варианты времени или неясно само действие. Когда напомнить и что именно нужно сделать?',
