...
Если смысл неоднозначен, фраза содержит несколько самостоятельных заданий либо непонятно, новая это запись или изменение черновика, верни mode="unclear", intent="unclear", confidence="low", proposal=null и ambiguity="event_or_expense|multiple_requests|new_or_amend|intent". Не маскируй непонимание под заметку.
